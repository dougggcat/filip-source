...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		sprDifficulty.animation.addByPrefix('but-fast', 'BUT-FAST');
		...
		txtTracklist = new FlxText(FlxG.width * 0.05, yellowBG.x + yellowBG.height + 100, 0, "Tracks", 16);
	...
	function changeDifficulty(change:Int = 0):Void
	{
		...
		switch (curDifficulty)
		{
			...
			case 2:
				sprDifficulty.animation.play('but-fast');
				sprDifficulty.offset.x = 70;
		}
